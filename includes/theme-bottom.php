...
<?php /*?>*small description:bottom theme (footer).
*
*@package
...
<?php */?>
	...
	<script src="http://maps.googleapis.com/maps/api/js?key=AIzaSyDbQYTiRrft8Pi5JmZnvMj0s6THIrnfOxA&sensor=false"></script>
